...
```{r stopwordremoval_miretrieve, eval = FALSE}
...
```{r stopwordremoval_tidytext, eval = FALSE}
...
often a miRNA must be in an abstract/string to be extracted.
...
```{r, eval = FALSE}
# Identify most frequent unique terms of miR-126 per topic
